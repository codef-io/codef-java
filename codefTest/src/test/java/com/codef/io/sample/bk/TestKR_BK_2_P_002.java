 ...
 *
 */
public class TestKR_BK_2_P_002 {
	
	@Test
	public void testKR_BK_2_P_002() throws IOException, InterruptedException, ParseException {
		// 요청 URL 설정
		String urlPath = CommonConstant.getRequestDomain() + CommonConstant.KR_BK_2_P_002;
