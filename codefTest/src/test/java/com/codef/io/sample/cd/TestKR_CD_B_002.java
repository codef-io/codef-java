 ...
 *
 */
public class TestKR_CD_B_002 {
	
	@Test
	public void testKR_CD_B_002() throws IOException, InterruptedException, ParseException {
		// 요청 URL 설정
		String urlPath = CommonConstant.getRequestDomain() + CommonConstant.KR_CD_B_002;
