 ...
 * 카드 법인 보유내역 조회
 */
public class TestKR_CD_B_001 {
	
	@Test
	public void testKR_CD_B_001() throws IOException, InterruptedException, ParseException {
		// 요청 URL 설정
		String urlPath = CommonConstant.getRequestDomain() + CommonConstant.KR_CD_B_001;
