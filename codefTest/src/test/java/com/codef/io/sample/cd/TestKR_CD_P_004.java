 ...
 * 카드 개인 한도조회
 */
public class TestKR_CD_P_004 {
	
	@Test
	public void testKR_CD_P_004() throws IOException, InterruptedException, ParseException {
		// 요청 URL 설정
		String urlPath = CommonConstant.getRequestDomain() + CommonConstant.KR_CD_P_004;
