 ...
 * 은행 개인 대출 거래내역	
 */
public class TestKR_BK_1_P_004 {
	
	@Test
	public void testKR_BK_1_P_004() throws IOException, InterruptedException, ParseException {
		// 요청 URL 설정
		String urlPath = CommonConstant.getRequestDomain() + CommonConstant.KR_BK_1_P_004;
		...
		bodyMap.put("accountLoanExecNo",	"대출실행번호");
		// 요청 파라미터 설정 종료
