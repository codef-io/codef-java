 ...
 * 은행 법인 수시입출 거래내역	
 */
public class TestKR_BK_1_B_002 {

	@Test
	public void testKR_BK_1_B_002() throws IOException, InterruptedException, ParseException {
		// 요청 URL 설정
		String urlPath = CommonConstant.API_DOMAIN + CommonConstant.KR_BK_1_B_002;
