 ...
 * 은행 개인 적금 거래내역		
 */
public class TestKR_BK_1_P_003 {
	
	@Test
	public void testKR_BK_1_P_003() throws IOException, InterruptedException, ParseException {
		// 요청 URL 설정
		String urlPath = CommonConstant.getRequestDomain() + CommonConstant.KR_BK_1_P_003;
